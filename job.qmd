...
job_cvar
# Produce Figure 1
ggsave("./plots/job_cvar.png", plot = job_cvar, dpi = 300, height = 3.8, width = 6.3)
```
...
# Produce Figure EC.1
ggsave("./plots/job_cvar_notrearranged.png", plot = job_cvar_notrearranged, dpi = 300, height = 3.8, width = 6.3)
```
...
job_cvar.plugin
# Produce Figure 3
ggsave("./plots/job_cvar_plugin.png", plot = job_cvar.plugin, dpi = 300, height = 3.8, width = 6.3)
```
...
job_cvar.bad
# Produce Figure 4
ggsave("./plots/job_cvar_bad.png", plot = job_cvar.bad, dpi = 300, height = 3.8, width = 6.3)
```
...
job_cvarvsate
# Produce Figure 2
ggsave("./plots/job_cvarvsate.png", plot = job_cvarvsate, dpi = 300, height = 3.8, width = 6.3)
```
...
job_bounded_bounds
# Produce Figure 5
ggsave("./plots/job_bounded_bounds.png", plot = job_bounded_bounds, dpi = 300, height = 3.8, width = 6.3)
```
...
job_condvar_bounds
# Produce Figure 6
ggsave("./plots/job_condvar_bounds.png", plot = job_condvar_bounds + theme(legend.spacing.y = unit(0.1, "cm")), dpi = 300, height = 3.8, width = 6.3)
```
...
job_cvar_te
# Produce Figure EC.2
ggsave("./plots/job_cvar_te.png", plot = job_cvar_te, dpi = 300, height = 3.8, width = 6.3)
```
